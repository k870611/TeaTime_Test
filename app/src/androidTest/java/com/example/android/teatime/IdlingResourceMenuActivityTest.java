...
public class IdlingResourceMenuActivityTest {
    ...
    // TODO (19) Registers any resource that needs to be synchronized with Espresso before
    // the test is run.
    @Before
    ...
    // TODO (20) Test that the gridView with Tea objects appears and we can click a gridView item
    @Test
    ...
    // TODO (21) Unregister resources when not needed to avoid malfunction
    @After
