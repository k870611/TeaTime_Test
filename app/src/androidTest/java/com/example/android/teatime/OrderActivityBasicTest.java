...
// TODO (2) Add annotation to specify AndroidJUnitRunner class as the default test runner
...
public class OrderActivityBasicTest {
    ...
    // TODO (3) Add the rule that provides functional testing of a single activity
    @Rule
    public ActivityTestRule<OrderActivity> mActivityTestRule =
            new ActivityTestRule<>(OrderActivity.class);

    // TODO (4) Finish writing this test which will:
