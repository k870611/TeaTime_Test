...
// TODO (14) Implement ImageDownloader.DelayerCallback
public class MenuActivity extends AppCompatActivity implements ImageDownloader.DelayerCallback {
    ...
    // TODO (15) Add a SimpleIdlingResource variable that will be null in production

    /**
     * TODO (16) Create a method that returns the IdlingResource variable. It will
    ...
    /**
     * TODO (17) Using the method you created, get the IdlingResource variable.
    ...
    // TODO (18) Override onDone so when the thread in ImageDownloader is finished, it returns an
